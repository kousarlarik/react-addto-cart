...
import Product1 from '../../asest/annar juice.jpg';
import Product2 from '../../asest/lays.avif';
import Product3 from '../../asest/annar juice.jpg';
import Product4 from '../../asest/ye.jpeg';
import Product5 from '../../asest/lays.avif';
        ...
        <>
            ...
            <Box sx={{ display: "flex", gap: "30px" }} className="container mt-5">
                {dummyproducts?.map((product, index) => (
                    ...
                    <Card key={index} sx={{ padding: "30px", cursor: "pointer", width: "20%", textAlign: "center" }}>
                        <Box>
                            <img className="product-image w-75 h-100" src={product.img} alt={`${product.name}`} />
